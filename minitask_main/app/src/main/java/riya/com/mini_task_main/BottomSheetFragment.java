...
public class BottomSheetFragment extends BottomSheetDialogFragment {
    ...
    private PersonalDetails PD[]= realm.where(PersonalDetails.class).lessThan("id", 11).greaterThan("id", 0).findAll().toArray(new PersonalDetails[0]);
...
//        e.setText((CharSequence) PD[(int)getArguments().getSerializable("data")].getEmail());
//        a.setText((CharSequence) PD[(int)getArguments().getSerializable("data")].getAddress());
        e.setText("email");
        a.setText("address");
        if (savedInstanceState == null) {
            //BottomSheetFragment fragment=new BottomSheetFragment();
           BottomSheetFragment fragment = (BottomSheetFragment) BottomSheetFragment.instantiate(getActivity(),
                    BottomSheetFragment.class.getName(), getArguments());
